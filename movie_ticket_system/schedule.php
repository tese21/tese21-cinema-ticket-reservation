            ...
            if ($result->num_rows > 0):
                while ($schedule = $result->fetch_assoc()): ?>
                    <div class="bg-white p-4 rounded-lg shadow-md">
                        ...
                        <a href="login.php?schedule_id=<?php echo $schedule['ScheduleID']; ?>" class="block mt-4 bg-yellow-500 text-black py-2 px-4 rounded hover:bg-yellow-600 transition duration-300 text-center">Book Now</a>
                    </div>
                <?php endwhile;
            else:
